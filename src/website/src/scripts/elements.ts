...
export const marketsItems = document.querySelectorAll<HTMLAnchorElement>('#markets a')
export const marketsToggle = document.querySelector<HTMLInputElement>('#markets_menu')!
